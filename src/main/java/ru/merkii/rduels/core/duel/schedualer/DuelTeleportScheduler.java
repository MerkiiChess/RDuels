    ...
    public void run() {
        ...
        if (this.duelFightModel.getArenaModel().isFfa()) {
            if (this.duelFightModel.getReceiverParty() != null && this.duelFightModel.getSenderParty() != null) {
                PlayerUtil.convertListUUID(this.duelFightModel.getReceiverParty().getPlayers()).forEach(this.duelAPI::addNoMove);
                PlayerUtil.convertListUUID(this.duelFightModel.getSenderParty().getPlayers()).forEach(this.duelAPI::addNoMove);
            } else {
