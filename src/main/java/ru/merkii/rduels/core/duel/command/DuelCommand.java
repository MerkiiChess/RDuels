...
public class DuelCommand {
    ...
    @Command("duel")
    public void duel(BukkitCommandActor actor) {
        config.sendTo(actor.requirePlayer(), "duel-args");
    }

    @Command("duel <receiver>")
    ...
    @Command("duel yes")
    public void yes(BukkitCommandActor actor) {
        config.sendTo(actor.requirePlayer(), "duel-yes-args");
    }

    @Command("duel yes <sender>")
    ...
    @Command("duel no")
    public void no(BukkitCommandActor actor) {
