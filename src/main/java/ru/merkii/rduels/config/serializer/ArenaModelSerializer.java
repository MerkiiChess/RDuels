...
public class ArenaModelSerializer implements TypeSerializer<ArenaModel> {
    ...
    public ArenaModel deserialize(Type type, ConfigurationNode node) throws SerializationException {
        ...
        return new ArenaModel(arenaName, displayName, material, customKits, customKitsName, ffa, breaking, schematic, radiusDeleteBlocks, onePosition, twoPosition, spectatorPosition, ffaPositions, schematicPosition);
    }
