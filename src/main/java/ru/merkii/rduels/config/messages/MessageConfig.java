...
public interface MessageConfig {
    ...
    default void send(BukkitCommandActor actor, String key) {
        actor.requirePlayer().sendMessage(message(key));
    }

    default void send(BukkitCommandActor actor, Placeholder.Placeholders placeholders, String key) {
        actor.requirePlayer().sendMessage(message(placeholders, key));
    }
