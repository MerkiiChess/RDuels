...
public class ConfigFactory {
    ...
    @Bean
    public CategoryItemConfiguration categoryItemConfiguration(ResourceConfiguration resourceConfiguration) {
        return resourceConfiguration.getConfig("category-items.yml", CategoryItemConfiguration.class);
    }

    @Bean
    public EnchantItemConfiguration enchantItemConfiguration(ResourceConfiguration resourceConfiguration) {
        return resourceConfiguration.getConfig("enchants-items.yml", EnchantItemConfiguration.class);
    }

    @Bean
    public TitleSettingsConfiguration titleSettingsConfiguration(DuelConfiguration duelConfiguration) {
        return duelConfiguration.titleSettings();
    }
