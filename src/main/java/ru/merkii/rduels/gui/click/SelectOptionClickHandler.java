...
public record SelectOptionClickHandler(MenuConfiguration config) implements ClickHandlerRegistry.ClickHandlerFacade {
    ...
    public void handle(InventoryContext context, Player player, AbstractClickHandler handler) {
        ...
        DuelOptionModel duelOptionModel = context.require("model");
