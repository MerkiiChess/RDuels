...
public class DuelRequestNumGamesClickHandler implements ClickHandlerRegistry.ClickHandlerFacade {

    public static final String NAME = "DUEL_REQUEST_NUM_GAMES_OPTION";
    private final InventoryGUIFactory factory;

    public DuelRequestNumGamesClickHandler(InventoryGUIFactory factory) {
    ...
    public void handle(InventoryContext context, Player player, AbstractClickHandler handler) {
        ...
        newContext.overrideOrCreate("option_type", "num_games");
